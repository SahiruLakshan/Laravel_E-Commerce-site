...
Route::middleware(['auth','isAdmin'])->group(function(){
    ...
    Route::get('/Add-Admin','Admin\DashboardController@addadmin');
    Route::post('Add-admin-update','Admin\DashboardController@update');
    Route::get('admins','Admin\DashboardController@admins');
    Route::get('view-user/{id}','Admin\DashboardController@viewusers');

    Route::get('/load-order','Admin\OrderController@ordercount');
